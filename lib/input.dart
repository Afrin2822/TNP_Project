...
import 'package:tnpfinal/pdf.dart';
...
class _MyInputState extends State<MyInput> {
  ...
  final TextEditingController _aggregatecgpaController = TextEditingController();
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              TextFormField(
                controller: _aggregatecgpaController,
                decoration: InputDecoration(
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    print('Aggregate CGPA: ${_aggregatecgpaController.text}');
                  ...
                  collRef.add({
                    ...
                    'PRN Number': _prnNumberController.text,
                    'Registration ID': _registrationIdController.text,
                    'Year of Passing': _yearOfPassingController.text,
                    'Diploma Details': _diplomaDetailsController.text,
                    'Starting College Year': _startingCollegeYearController.text,
                    'Aggregate CGPA': _aggregatecgpaController.text,
                    // 'Sem 2 CGPA': _sem2CgpaController.text,
                    // 'Sem 3 SGPA': _sem3SgpaController.text,
                    // 'Sem 4 CGPA': _sem4CgpaController.text,
                    'Number of Backlogs': _backlogsController.text,
                    'Aadhar Number': _aadharNumberController.text,
                    'AMCAT Logical Ability Score': _amcatLogicalScoreController.text,
                    'AMCAT Quantitative Ability Score': _amcatQuantitativeScoreController.text,
                    'AMCAT Automata Score': _amcatAutomataScoreController.text,
                  }
                  );
                },
                child: Text('Submit'),
              ...
              ElevatedButton(
                onPressed: () {
                  // Navigate to MyPdf screen
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => MyPdf()),
                  );
                },
                child: Text('Submit PDF here'),
              ),
            ],
          ),
        ),
...
// import 'package:cloud_firestore/cloud_firestore.dart';
// import 'package:flutter/material.dart';
// import 'package:pbl_saiee/pdf.dart';
//
// class MyInput extends StatefulWidget {
//   const MyInput({Key? key}) : super(key: key);
//
...
//             'Diploma Details': _diplomaDetailsController.text,
//             'Starting College Year': _startingCollegeYearController.text,
//             'Sem 1 SGPA': _sem1SgpaController.text,
//             'Sem 2 CGPA': _sem2CgpaController.text,
//             'Sem 3 SGPA': _sem3SgpaController.text,
//             'Sem 4 CGPA': _sem4CgpaController.text,
//             'Number of Backlogs': _backlogsController.text,
